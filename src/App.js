...
import photoWarhol from './assets/warhol/photo.jpg'
...
import photoBotticelli from './assets/boticelli/photo.jpg'
...
function App() {
  return (
    ...
    <GlobalStyle />
        ...
        <Route path="/davinci" element={<Perfil backgrondPhoto={obraVinci} photo={photoDaVinci} name={'Leonardo da Vinci'} head={'engenheiro, inventor, anatomista, pintor, escultor...'} bio={'Leonardo da Vinci (1452-1519) foi um polímata italiano do Renascimento, considerado um dos maiores gênios da humanidade. Ele se destacou como cientista, matemático, engenheiro, inventor, anatomista, pintor, escultor, arquiteto, botânico, poeta e músico. É considerado um dos maiores pintores de todos os tempos. Seus trabalhos e projetos científicos quase sempre ficaram escondidos em livros de anotações'} title={'Mona Lisa'} title2={'A última ceia'} title3={'Homem Vitruviano'} author={'Vincent Van Gogh'} obra={obraVinci} obra2={obraVinci2} obra3={obraVinci3} price={1999.90} price2={1199.90} price3={'899.90'} />} />
